...
public class Skill_Melee : CoroutineSkill
{
    ...
    protected override IEnumerator Use(Flow flow, GameObject gameObject, Weapon weapon)
    {
        ...
        triggerObj.transform.position = weapon.con.transform.position + (Vector3)weapon.con.conData.center;//-|
        ...
        while (t < 1)
        {
            ...
            triggerObj.transform.position = (Vector2)weapon.con.transform.position + weapon.con.conData.center//-|
