...
[UnitTitle("Attack")]//The Custom Scripting Event node to receive the Event. Add "On" to the node title as an Event naming convention.
[UnitCategory("WeaponEvents")]//Set the path to find the node in the fuzzy finder as Events > My Events.
public class AttackEventNode : GameObjectEventUnit<int>
{
    public static string eventName = "AttackEvent";
